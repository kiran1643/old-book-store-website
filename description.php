    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img alt="Brand" src="Images/Logo/obs.png" style="width: 180px;margin-top: -7px;margin-left: -10px;"></a>
        </div>
    ...
    <div class="row">
      <div class="col-sm-10 col-md-6">
                          <div class="tag">'.$row["Discount"].'%OFF</div>
                              <div class="tag-side"><img src="Images/Logo/orange-flag.png">
                          </div>
                         <img class="center-block img-responsive" src="'.$path.'" style="padding:20px; width:200px">
      </div>
...
<div class="container-fluid" id="service">
      <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
               ...
               24X7 Care <br>
               Happy to help 24X7, call us on 8080515308 
          </div>
          <div class="col-sm-6 col-md-3 text-center">
